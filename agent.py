...
class Agent:
    ...
    def __init__(self):
        ...
        if os.path.isfile("./model/model.pth"):
            ...
            print("SUCESSFULLY LOADED SAVED MODEL")
    ...
    def get_action(self, state):
        ...
        # RANDOM MOVE IF CONDITION IS MET, LESS CHANCE THE MORE WE TRAIN
        if random.randint(0, 200) < self.epsilon:
            move = random.randint(0, 2)
            final_move[move] = 1
        
        # USE PREDICTION IF NOT RANDOM
        else:
...
def train():
    ...
    while True:
        ...
        if game_over:
            # train long memory (replaying memory), plot result
            game.reset()
            agent.n_games += 1
